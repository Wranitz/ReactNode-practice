...
class AddPost extends React.Component {
    constructor(props){
        ...
        this.getPostWithID = this.addPost.bind(this);
        ...
        return (
            ...
            <br styles="clear:both" />
                <div className="form-group">
                    <input type="text" value={this.state.title} onChange={this.handleTitleChange} className="form-control" id="title" placeholder="Title" required />
                </div>
                <div className="form-group">
                ...
                <button type="button" onClick={this.addPost} id="submit" className="btn btn-primary pull-right">Add Post</button>
            </form>
            </div>
        )
    }
